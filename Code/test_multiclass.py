    ...
    if output_mode == "binary":
        ...
        for x in X:
            ...
            if x.shape[0] < pred_hours + min_ob_window:
                ...
                hours_left.append(x.shape[0] - rand_cut)
        ...
        for x in X:
            ...
            if ix == 0:
                ...
                # Cut randomly before the longest prediction window
                ...
                # Cut randomly within the interval chosen
...
def test_model(model, test_df):
    ...
    # print(len(y_predict), len(y_test), len(test_loss_trend), len(test_acc_trend))
...
# output_dim = [int(sys.argv[8]), int(sys.argv[9]), int(sys.argv[10])]
